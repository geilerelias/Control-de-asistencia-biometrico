...
public class ElevationEffectCircle {
    ...
    public void paint(Graphics g) {
        ...
        g.drawImage(MaterialShadowCircle.renderCircularShadow(target.getWidth(), level.getValue()), 0, 0, null);
//        g.drawImage(MaterialShadowCircle.renderShadow(target.getWidth(), target.getHeight(), level.getValue()), 0, 0, null);
    }
    ...
    public static ElevationEffectCircle applyCirularTo(JComponent target, int level) {
        return new ElevationEffectCircle.Circular(target, level);
    }
