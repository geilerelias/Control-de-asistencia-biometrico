...
import MaterialEfectos.ElevationEffectCircle;
import MaterialEfectos.MaterialShadowCircle;
 ...
 */
public class MaterialButtonCirclePanel extends JPanel {
     ...
     */
    public MaterialButtonCirclePanel() {
        ...
        setFont(Roboto.MEDIUM.deriveFont(17f));

        setUI(new BasicPanelUI() {
            @Override
            public boolean contains(JComponent c, int x, int y) {
                return x > MaterialShadowCircle.OFFSET_LEFT && y > MaterialShadowCircle.OFFSET_TOP
                        && x < getWidth() - MaterialShadowCircle.OFFSET_RIGHT && y < getHeight() - MaterialShadowCircle.OFFSET_BOTTOM;
            }
        });
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.translate(MaterialShadowCircle.OFFSET_LEFT, MaterialShadowCircle.OFFSET_TOP);

        final int offset_lr = MaterialShadowCircle.OFFSET_LEFT + MaterialShadowCircle.OFFSET_RIGHT;
        final int offset_td = MaterialShadowCircle.OFFSET_TOP + MaterialShadowCircle.OFFSET_BOTTOM;
