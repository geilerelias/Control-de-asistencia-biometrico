...
import MaterialEfectos.SafePropertySetter;
...
//        setBorder(null);
//        setFont(Roboto.LIGHT_ITALIC.deriveFont(16f));
...
//    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.setColor(MaterialColor.BLACK);
        g2.fillRect(0, getHeight() - 9, getWidth(), 1);

        g2.setColor(MaterialColor.GREEN_500);
    ...
    public static class FloatingLabel {
        ...
        FloatingLabel(JPasswordField target) {
            this.target = target;
            this.timer = new SwingTimerTimingSource();
            timer.init();
        ...
        void update() {
            ...
            if (target.getText().isEmpty() && target.isFocusOwner()) {
                targetColor = MaterialColor.GREEN_50;
            } else {
