...
import MaterialEfectos.ElevationEffectRectangle;
import MaterialEfectos.MaterialShadow;
import MaterialEfectos.MaterialShadowRectangle;
 ...
 */
public class MaterialButtomRectangle extends JButton {

    private RippleEffect ripple;
    private ElevationEffectRectangle elevation;
     ...
     */
    public MaterialButtomRectangle() {
        ripple = RippleEffect.applyTo(this);
        elevation = ElevationEffectRectangle.applyTo(this, 0);
        setOpaque(false);
        ...
        setUI(new BasicButtonUI() {
            ...
            public boolean contains(JComponent c, int x, int y) {
                return x > MaterialShadowRectangle.OFFSET_LEFT && y > MaterialShadowRectangle.OFFSET_TOP
                        && x < getWidth() - MaterialShadowRectangle.OFFSET_RIGHT && y < getHeight() - MaterialShadowRectangle.OFFSET_BOTTOM;
            }
        });
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.translate(MaterialShadowRectangle.OFFSET_LEFT, MaterialShadowRectangle.OFFSET_TOP);

        final int offset_lr = MaterialShadowRectangle.OFFSET_LEFT + MaterialShadowRectangle.OFFSET_RIGHT;
        final int offset_td = MaterialShadowRectangle.OFFSET_TOP + MaterialShadowRectangle.OFFSET_BOTTOM;

        if (isEnabled()) {
            g2.setColor(getBackground());
            g2.fill(new RoundRectangle2D.Float(0, 0, getWidth() - offset_lr, getHeight() - offset_td, 30, 30));
        ...
        if (isEnabled()) {
            g2.setClip(new RoundRectangle2D.Float(0, 0, getWidth() - offset_lr, getHeight() - offset_td, 30, 30));
    ...
    public enum Type {
        ...
        DEFAULT,
        /**
         * A raised button. Raised buttons have shadow even if they are not
         * focused.
         */
        RAISED,
        /**
